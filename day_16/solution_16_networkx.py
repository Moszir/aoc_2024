...
for r, row in enumerate(grid):
    for c, cell in enumerate(row):
        if cell != '#':
            # Turning is expensive
            G.add_edge((r, c, 1, 0), (r, c, 0, -1), weight=1000)
            G.add_edge((r, c, 1, 0), (r, c, 0, 1), weight=1000)
            G.add_edge((r, c, -1, 0), (r, c, 0, -1), weight=1000)
            G.add_edge((r, c, -1, 0), (r, c, 0, 1), weight=1000)
            G.add_edge((r, c, 0, 1), (r, c, -1, 0), weight=1000)
            G.add_edge((r, c, 0, 1), (r, c, 1, 0), weight=1000)
            G.add_edge((r, c, 0, -1), (r, c, -1, 0), weight=1000)
            G.add_edge((r, c, 0, -1), (r, c, 1, 0), weight=1000)
            ...
            for dr, dc in ((0, 1), (0, -1), (1, 0), (-1, 0)):
                if grid[r + dr][c + dc] != '#':
                    # Moving to the cell, keeping the direction
